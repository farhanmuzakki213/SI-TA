...
<body>
    ...
    <div class="badan">
        ...
        <table class="isi">
            ...
            <tbody>
                <tr class="table-light">
                    ...
                    <td class="nip">{{ $data_sidang_ta->r_ketua->nip_dosen }}</td>
                ...
                <tr class="table-light">
                    ...
                    <td class="nip">{{ $data_sidang_ta->r_sekretaris->nip_dosen }}</td>
                ...
                <tr class="table-light">
                    ...
                    <td class="nip">{{ $data_sidang_ta->r_penguji_1->nip_dosen }}</td>
                ...
                <tr class="table-light">
                    ...
                    <td class="nip">{{ $data_sidang_ta->r_penguji_2->nip_dosen }}</td>
        ...
        <div style="margin-bottom: 1%;">
            <font style="font-size: 15px;">Untuk melaksanakan Sidang Tugas Akhir Mahasiswa Jurusan {{$kajur->r_prodi->r_jurusan->nama_jurusan}} yang disebut dibawah ini</font>
        </div>
            ...
            <table class="details-table" style="padding-left: 20px;">
                @if ($data_sidang_ta)
                    ...
                    <tr>
                        ...
                        <td class="value">: {{ $data_sidang_ta->r_mahasiswa->r_kelas->r_prodi->nama_prodi }}
                        </td>
                    </tr>
                    <tr>
