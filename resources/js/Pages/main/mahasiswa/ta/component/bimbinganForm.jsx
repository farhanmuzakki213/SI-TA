                ...
                <div className="formgrid grid">
                    <div className="field-radiobutton col-6">
                        <RadioButton
                            ...
                            name="sebagai"
                            value="pembimbing_1"
                            onChange={(e) => onSebagaiChange(e, data_mhs_ta.pembimbing_1_id)}
                            checked={bimbingan.sebagai === "pembimbing_1"}
                        />
                        <label htmlFor="sebagai1">{data_mhs_ta.nama_pembimbing_1}</label>
                    </div>
                    <div className="field-radiobutton col-6">
                        <RadioButton
                            inputId="sebagai2"
                            name="sebagai"
                            value="pembimbing_2"
                            onChange={(e) => onSebagaiChange(e, data_mhs_ta.pembimbing_2_id)}
                            checked={bimbingan.sebagai === "pembimbing_2"}
                        />
                        <label htmlFor="sebagai2">{data_mhs_ta.nama_pembimbing_2}</label>
                    </div>
                </div>
            </div>
