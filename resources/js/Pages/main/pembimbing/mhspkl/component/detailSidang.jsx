...
const detailSidang = ({
    ...
    const nilaiAkhir = ((data_mhss.nilai_industri + nilaiPenguji.total_nilai + nilaiPembimbing.total_nilai) / 3) ?? null;
    console.log(nilaiAkhir, nilaiPenguji, nilaiPembimbing);
    return (
        <div className="card">
                ...
                <div>
                    ...
                    {!nilaiPembimbing.total_nilai ? (
                        <div className="tw-flex tw-justify-between tw-items-start">
                            ...
                            {data_mhss.tgl_sidang && new Date(data_mhss.tgl_sidang).toDateString() === new Date().toDateString() &&(<Button icon="pi pi-pencil" severity="success" outlined rounded
