...
const NilaipklDataTable = ({ nilaipkls, selectednilaipkls, setSelectednilaipkls, globalFilter, header, editnilaipkl, dt }) => {
    ...
    return (
        <DataTable
            ref={dt}
            value={nilaipkls}
            selection={selectednilaipkls}
            onSelectionChange={(e) => setSelectednilaipkls(e.value)}
            ...
            currentPageReportTemplate="Showing {first} to {last} of {totalRecords} nilaipkls"
            globalFilter={globalFilter}
            emptyMessage="No nilaipkls found."
            header={header}
...
export default NilaipklDataTable;
