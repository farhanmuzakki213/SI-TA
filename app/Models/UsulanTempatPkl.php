...
class UsulanTempatPkl extends Model
{
    use HasFactory;
    protected $fillable = [
        'id_usulan', 'tempat_pkl_id', 'role_tempat_pkl_id', 'kota_perusahaan', 'alamat_tempat_pkl', 'mahasiswa_id', 'file_pendukung', 'tgl_awal_pkl', 'tgl_akhir_pkl', 'komentar', 'status_usulan'
    ];
