...
class MhsTAResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'nilai_pembimbing_1' => $pembimbing_1->nilai ?? null,
            'komentar_pembimbing_1' => $pembimbing_1->komentar ?? '',
            'nilai_pembimbing_2' => $pembimbing_2->nilai ?? null,
            'komentar_pembimbing_2' => $pembimbing_2->komentar ?? '',
            'nilai_penguji_1' => $penguji_1->nilai ?? null,
            'komentar_penguji_1' => $penguji_1->komentar ?? '',
            'nilai_penguji_2' => $penguji_2->nilai ?? null,
            'komentar_penguji_2' => $penguji_2->komentar ?? '',
            'nilai_ketua' => $ketua->nilai ?? null,
            'komentar_ketua' => $ketua->komentar ?? '',
            'nilai_sekretaris' => $sekretaris->nilai ?? null,
            'komentar_sekretaris' => $sekretaris->komentar ?? '',
